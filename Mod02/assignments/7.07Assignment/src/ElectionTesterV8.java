...
public class ElectionTesterV8 {
    ...
    public static void candiSelectRemoval(ArrayList<Candidate> array, int pos) {
        System.out.println(array.get(pos).getName() + " has been removed from the election. Leaving " + array.get(pos).getVotes() + " votes nullified.");
        array.remove(pos);
        finalOutput(array);
    }

    public static void candiSearchRemoval(ArrayList<Candidate> array, String candiName) {
        int pos = 0;
        for (Candidate candis : array) {
        ...
        System.out.println(candiName + " has been removed from the election. Leaving " + array.get(pos).getVotes() + " votes nullified.");
        array.remove(pos);
        finalOutput(array);
    ...
    public static void main(String[] args) {
        ...
        candiSelectRemoval(candiBois, 2);
        System.out.println();

        candiSearchRemoval(candiBois, "Jack Black");
        System.out.println();
